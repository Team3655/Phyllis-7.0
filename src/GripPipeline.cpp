...
void GripPipeline::process(cv::Mat source0){
	...
	double hslThresholdHue[] = {63.129496402877706, 109.35153583617748};
	...
	double filterContoursMinPerimeter = 12.0;  // default Double
	double filterContoursMinWidth = 9.0;  // default Double
	...
	double filterContoursSolidity[] = {68.34532374100718, 100};
